...
CREATE TABLE "wallets" (
    ...
    "sbtcBalance" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "products" (
    ...
    "priceSbtc" DOUBLE PRECISION NOT NULL,
    "imageUrl" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "orders" (
    ...
    "totalSbtc" DOUBLE PRECISION NOT NULL,
...
CREATE TABLE "transactions" (
    ...
    "amountSbtc" DOUBLE PRECISION NOT NULL,
    "type" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "orders_qrCodeData_key" ON "orders"("qrCodeData");
